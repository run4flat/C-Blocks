...
As of May 21, 2014, the pass/fail matrix is this:
 ...
 System \ Test        | 01 | 02 | 03 | 04 | 10 |
 -----------------------------------------------
 XP Strawberry 5.18   |  y |  y |  y | #1 | #2 |
 Mac perlbrew 5.18 sh |  y |  y |  y |  y | #3 |
 Mac perlbrew 5.18 st |  y |  y |  y | #4 | #3 |
 Wheezy sys 5.14      |  y |  y |  y |  y | #3 |
...
On Windows XP running Strawberry Perl 5.18, all cblocks compile fine.
However, the test script crashes when trying to call the third cblock.

=item 3

On Mac and Linux, test 10 displays no output except for the error
