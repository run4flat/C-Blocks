...
As of May 29, 2014, the pass/fail matrix is this:
 ...
 ------------------------------------------------------------------------------
 Ubuntu 14.10 brew 5.20 |  y |  y |  y |  y | #1 |  y |  y |  y |  y |  y |  y
 Win7 Strawberry 5.18   |  y |  y |  y | #2 | #1 |  y |  y |  y |  y |  y |  y
...
Test #10 subtest 30 indicates that static variables delcared in C<clex> or
C<cshare> blocks cannot be accessed directly in later blocks.
