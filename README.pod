...
On Mac OSX 10.7 (Lion), running test 10 with C<prove> results in the following
error:
...
On Mac OSX Lion running perlbrew 5.18, and on Windows XP running
Strawberry Perl v5.18, test #12 segfaults after
